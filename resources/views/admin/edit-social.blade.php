            ...
            @endif
              <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                  <label for="input-1" class="col-sm-2 col-form-label">Icon</label>
                  <div class="col-sm-10">
                    <input type="text" name="icon" class="form-control" id="input-1" value="{{ $social->icon }}" required>
                  </div>
                </div>

                <div class="form-group row">
                        <label for="input-2" class="col-sm-2 col-form-label">Link</label>
                        <div class="col-sm-10">
                          <input type="text" name="link" class="form-control" id="input-2" value="{{ $social->link }}" required>
                        </div>
                      </div>
