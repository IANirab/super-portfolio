            ...
            @endif
              <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="name" class="form-control" value="{{ $skill->name }}" id="input-1" required>
                  </div>
                </div>
                <div class="form-group row">
                        <label for="input-2" class="col-sm-2 col-form-label">Persentage</label>
                        <div class="col-sm-10">
                          <input type="number" name="percent" class="form-control" value="{{ $skill->percent }}" id="input-2" required>
                        </div>
                </div>
